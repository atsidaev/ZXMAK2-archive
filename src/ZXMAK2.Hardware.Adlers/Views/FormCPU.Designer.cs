namespace ZXMAK2.Hardware.Adlers.Views
{
    partial class FormCpu
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.contextMenuStack = new System.Windows.Forms.ContextMenu();
        	...
        	this.listState.MouseUp += new System.Windows.Forms.MouseEventHandler(this.listState_MouseClick);
        	// 
        	// panelRegs
        	// 
        	...
        	// 
        	this.menuItemInsertBreakpointHere.Index = 4;
        	...
        	// menuItemDasmRefresh
        	// 
        	this.menuItemDasmRefresh.Index = 13;
        	...
        	// 
        	this.menuItemFollowInDisassembler.Index = 0;
        	...
        	// 
        	this.menuItemAddNewTraceAddrArea.Index = -1;
        	...
        	// contextMenuStack
        	// 
        	this.contextMenuStack.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
        ...
        private System.Windows.Forms.ContextMenu contextMenuStack;
    }
}