    ...
    public partial class TcpHelper : Form
    {
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                m_client.DownloadFileAsync(new Uri(@"http://download-codeplex.sec.s-msft.com/Download/Release?ProjectName=pasmo2&DownloadId=1422898&FileTime=130666609839170000&Build=20959"), "Pasmo2.dll");
            }
